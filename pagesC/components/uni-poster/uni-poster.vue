  ...
  data() {
    return {
      ...
      attrs:{//主板版海报
        ...
        innerTB: 20,
        posterRatio: 1.3,
        posterImgUrl: "http://47.102.124.213/images/guaHao/logo.png",
        title: "今日上新水果，牛奶草莓，颗粒饱满，每盒 200g",
        titleFontSize: 16,
        titleLineHeight: 25,
        posterCodeUrl: "http://47.102.124.213/images/guaHao/erweima.png",
        codeWidth: 0.3,
        codeRatio: 1,
        codeRadius: 0,
        codeMT: 20,
        ...
        codeNameMT: 20,
        tips: "长按/扫描识别查看商品",
        posterBgUrl:'http://47.102.124.213/images/guaHao/codeBg.jpg',
        codeML:140,
        desTextMT:70,
        desTextML:240,
      },
