...
<script>
	import { GetDoctorsByNamePercent,DoctorServlet} from '@/pages/common/api.js'
		...
		methods: {
			...
			getDoctorDetail: function(did,dname,dcount,dreceive,dfee,drole,dintroduce,hname,rname,dimg) {
				if (this.LoginIndex == '') {
					...
					var dimg = dimg				
					uni.navigateTo({
						url: '/pagesA/doctorDetail/doctorDetail?doctorId=' + doctorId + '&dname=' + dname + '&drole=' + drole + '&dcount=' +
